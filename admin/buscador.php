...
<title>Buscador — Pesquisa e Debate</title>
<style>
:root{
  color-scheme:light;
...
function addManual(e){
  ...
  note.textContent='Abra a sessão ChatGPT autenticada da VM/RDP e envie este prompt. A resposta não será lida automaticamente pelo Buscador.';
...
async function loadHealth(){
  ...
  try{
    ...
    document.getElementById('models').textContent='Não foi possível consultar o health do Buscador.';
  }
}
