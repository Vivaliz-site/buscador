...
Leia `docs/quality/AUDIT_MERGE_ENFORCEMENT_V1.md`. O gate local executa `scripts/absolute-audit-governance-validate.sh`; todo push em `main`/`master` deve passar pelo **Absolute Audit Main Guard** com prova de PR mesclado.
